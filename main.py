...
app.config['SQLALCHEMY_BINDS'] = {
    'users': os.getenv("postgres://mbzwsggnadjrjd:9a3319946d36610a8198446487e1d76d1442037e733d17afac1a424d87abb9d7@ec2-63-32-7-190.eu-west-1.compute.amazonaws.com:5432/dee635ogf0hvktL"),
    "comments": os.getenv("postgres://hcltntwfcownzx:c172ddaa141d17f018820a8291e27d6cb03dc7ef0a0c9f2720f46fbc668842c0@ec2-63-32-7-190.eu-west-1.compute.amazonaws.com:5432/dc6uqsi72osd64")
}
...
def register():
    ...
    if form.validate_on_submit():
        if User.query.filter_by(email=form.email.data).first():
            ...
            hashed_and_salted_pwd = generate_password_hash(form.password.data, method='pbkdf2:sha256', salt_length=100)
            new_user = User(
                name=form.name.data,
